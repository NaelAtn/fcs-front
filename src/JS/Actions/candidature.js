...
export const addCandidature = (postulation, navigate) => async (dispatch) => {
  ...
  try {
    let result = await axios.post(
      "https://demofcs.onrender.com/api/postulation/add-postulation",
      postulation
    );
...
export const getCandidature = () => async (dispatch) => {
  ...
  try {
    ...
    let result = await axios.get("https://demofcs.onrender.com/api/postulation/get-postulation", config);
...
export const deleteCandidature = (id) => async (dispatch) => {
  ...
  try {
    ...
    let result = await axios.delete(
      `https://demofcs.onrender.com/api/postulation/delete-postulation/${id}`,
      config
    );
    window.scrollTo({
      top: 0,
