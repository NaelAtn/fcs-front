...
export const addReservation = (newReservation,navigate) => async(dispatch) => {
    ...
    try {
        let result = await axios.post('https://demofcs.onrender.com/api/reservation/post-reservation',newReservation)
...
export const getReservation = () => async (dispatch) => {
    ...
    try {
        ...
        let result = await axios.get('https://demofcs.onrender.com/api/reservation/get-reservation',config)
...
export const deleteReservation= (id) => async (dispatch) => {
    ...
    try {
        ...
        let result = await axios.delete(`https://demofcs.onrender.com/api/reservation/${id}`,config)
...
export const updateisDoneReservation= (id,isDoneReservation) => async (dispatch) => {
    ...
    try {
        ...
        let result = await axios.put(`https://demofcs.onrender.com/api/reservation/updateIsDone/${id}`,isDoneReservation,config)
...
export const updatenotisDoneReservation= (id,NotisDoneReservation) => async (dispatch) => {
    ...
    try {
        ...
        let result = await axios.put(`https://demofcs.onrender.com/api/reservation/updateNotDone/${id}`,NotisDoneReservation,config)
        dispatch ({ type : ISDONE_RESERVATION, payload : result.data})
        dispatch (getReservation())
    } catch (error) {
        dispatch ({type : FAIL_RESERVATION , payload : error.response.data.errors})
