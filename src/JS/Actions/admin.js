...
export const loginAdmin = (admin, navigate) => async (dispatch) => {
  ...
  try {
    let result = await axios.post("https://demofcs.onrender.com/api/admin/loginAdmin", admin);
    navigate("/");
...
export const currentAdmin = () => async (dispatch) => {
  ...
  try {
    ...
    let result = await axios.get("https://demofcs.onrender.com/api/admin/currentAdmin", config);
...
export const editadminpassword = (id, newAdmin,navigate) => async (dispatch) => {
  ...
  try {
    ...
    let result = await axios.put(`https://demofcs.onrender.com/api/admin/password/${id}`, newAdmin,config);
