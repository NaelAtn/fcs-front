...
export const addOffredemploi = (newOffredemploi,navigate) => async (dispatch) => {
  ...
  try {
    ...
    let result = await axios.post(
      "https://demofcs.onrender.com/api/offredemploi/add-offre-d-emploi",
      newOffredemploi,
      config
    );
...
export const getOffredemploi = () => async (dispatch) => {
  dispatch({ type: LOAD_OFFREDEMPLOI });
  try {
    let result = await axios.get("https://demofcs.onrender.com/api/offredemploi/get-offre-d-emploi");
...
export const getOneOffre = (id) => async (dispatch) => {
  dispatch({ type: LOAD_OFFREDEMPLOI });
  try {
    let result = await axios.get(`https://demofcs.onrender.com/api/offredemploi/${id}`);
...
export const deleteOffredemploi = (id) => async (dispatch) => {
  ...
  try {
    ...
    let result = await axios.delete(`https://demofcs.onrender.com/api/offredemploi/${id}`, config);
